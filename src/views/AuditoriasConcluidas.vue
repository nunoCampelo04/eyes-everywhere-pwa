<template>
  <div class="page">
    <div class="content">
      ...
      <h2>Auditorias Concluídas</h2>
      <img src="../assets/concluidas-header.png" alt="Auditorias" class="header-img" />

      <div class="auditorias-list">
        <div class="card" v-for="aud in auditoriasFiltradas" :key="aud.id" @click="$router.push(`/auditoriasconcluidas/${aud.id}`)">
          <div class="data">
